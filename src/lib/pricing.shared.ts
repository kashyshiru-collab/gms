...
export const PAIRS: PairDef[] = [
  ...
  { symbol: "VOL50", label: "Volatility 50 Index", kind: "synthetic", category: "synthetic", seedOffset: 3050, vol: 0.003, basePrice: 1000, decimals: 5 },
  { symbol: "VOL100", label: "Volatility 100 Index", kind: "synthetic", category: "synthetic", seedOffset: 4100, vol: 0.006, basePrice: 1000, decimals: 5 },
